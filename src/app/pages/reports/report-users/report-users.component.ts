...
export class ReportUsersComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this.emailChartLegendItems = [
        { title: 'Alumnos', imageClass: 'fa fa-circle text-info' },
        { title: 'Profesores', imageClass: 'fa fa-circle text-danger' },
        { title: 'Administrativos', imageClass: 'fa fa-circle text-warning' }
      ];
